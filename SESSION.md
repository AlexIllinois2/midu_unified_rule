...
plan.txt 新增: 86 条
  ...
  - 削 ⇥ xue1 ⇥ TEXT(剥(削))
  - 数一数 ⇥ shu3 yi4 shu3 ⇥ TEXT((数一数))
  - 数数看 ⇥ shu3 shu3 kan4 ⇥ TEXT((数数看))
  - 你数数 ⇥ ni3 shu3 shu3 ⇥ TEXT((你数数))
  - 再数数 ⇥ zai4 shu3 shu3 ⇥ TEXT((再数数))
去重删除: 41 条
输出: 1314 条
分组: PINYIN 2 / WORD_INSIDE 22 / TEXT 1290
